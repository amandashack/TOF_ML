# -*- coding: utf-8 -*-
"""
Created on Thu Jul 20 14:18:08 2023
...
pdf_filename = 'tof_prediction_plots00.pdf'
pdf_pages = PdfPages(pdf_filename)

# Create a loop to train and plot the model for each number of epochs
for epochs in epochs_list:
    print(f"Training the model with {epochs} epochs")
    ...
    plt.legend()
    plt.title(f'Model with {epochs} epochs: Normal Method')
